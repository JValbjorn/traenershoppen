            ...
            <div className="flex flex-row gap-10">
                ...
                <article>
                    ...
                    <div className="flex flex-row justify-between mt-5">
                        <button onClick={() => {console.log("Shop videre er trykket")}} className="bg-none border-2 text-black font-bold min-w-40 px-6 py-3 hover:bg-black hover:text-white transition-colors duration-30">Tilbage til kontakt oplysninger</button>
                        <CTAButton text="Gå til betaling" onClick={() => {}} />
                    </div>
                </article>
            </div>
            <article>
