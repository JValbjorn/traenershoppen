...
export default function HomePageArch() {
  return (
    <motion.div
      className="cls-5 fill-white w-3/7 h-700 pt-30 absolute -left-10 bg-no-repeat bg-top min-h-20 2xl:top-[10%] xl:top-[23%] lg:top-[15%] md:top-[10%]"
      style={{
    ...
    >
      <div className="flex flex-col p-3 pl-10 justify-between min-h-100">
        ...
        <CTAButton text="Se tilbuddene" onClick={() => console.log("CTA Button Clicked")} />
      </div>
    </motion.div>
  );
}
